...
Here’s the code that enables this functionality. We modify the urlId parameter to ensure each thread is unique. Keep in mind that we use ids, but you can 
pass in any DOM element queried in any way you prefer.
