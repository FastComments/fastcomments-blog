...
What if your audience could comment on your blog posts, ask questions, and provide feedback? Now they can with FastComments.

#### Custom Themes
To add FastComments to your BigCommerce store's blog, you'll need to edit your theme templates. We'll guide you through it.
...
Under "Current Theme," you'll see a dropdown labeled "Advanced."
...
In this dropdown, the first option is "Edit Theme Files." If this option is not clickable, you will first need to copy the theme via "Make a Copy."
...
Your FastComments code snippet, which you can obtain from <a href="https://fastcomments.com/auth/my-account/get-acct-code" target="_blank">here</a>, should be pasted right after line 48, which contains the text "&#123;{>components/common/share}&#125;".
...
#### Remember!
You'll need to add your store's domain to FastComments, which you can do <a href="https://fastcomments.com/auth/my-account/configure-domains" target="_blank">here</a>.
