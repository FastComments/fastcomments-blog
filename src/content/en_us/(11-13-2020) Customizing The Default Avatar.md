...
The default icon has remained the same since FastComments launched. Behold the glory of the default profile icon.

<div class="text-center">
    <img src="https://fastcomments.com/images/unknown-person.png" title="Default Profile Icon" alt="Default Profile Icon" />
</div>

However, you can customize it now.
...
If you wish to host the default avatar, and you already have a public URL for it, it can be defined in code as in the given example.
...
1. Customizing the default profile picture only affects your site. It does not impact notification emails or the users' accounts in any way.
2. Comments created before this change may still display the old profile picture. If you adjust the default profile icon and observe many comments on your site
