...
{{#unless isPost}}
FastComments now supports adding a verified backup email to your account, providing you with an alternative way to recover access if you lose your primary email.
{{/unless}}
...
can be utilized to recover your account through any of our existing login flows.
