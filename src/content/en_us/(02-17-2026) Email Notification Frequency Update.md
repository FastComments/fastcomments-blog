...
This setting is available to both tenant admins and commenters, and applies to all comment notification emails. Note that @mention notifications are always sent immediately regardless of this setting.
