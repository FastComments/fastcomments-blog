...
New customers who sign up as of today will automatically get the new design. All of our frameworks, libraries, and
...
We are not currently setting an end of life for the previous version of the comment widget. This does not mean we will not
...
The new design supports dark mode, just like the original comment widget. All feature flags and settings have been migrated.
...
We've also completely revamped our build system to be able to have a shared code base between versions of the comment
