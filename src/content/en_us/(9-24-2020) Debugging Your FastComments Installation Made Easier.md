...
At <a href="https://fastcomments.com">FastComments</a>, we've just released a browser extension for Google Chrome. This extension will help you understand what configuration
the comment widget is receiving and why it may not be visible.
...
If you find that the comment widget is not loading, or some configuration you've set is not appearing, try installing <a href="https://chrome.google.com/webstore/detail/fastcomments-debugger/cadggdemhfkjjghkdbfhonoccnplffjj">the extension</a>
...
The FastComments Debug Tool does not communicate with any FastComments servers. In fact, the widget will not even check the content of the page you are on
unless you open it.
...
We know that in some cases you may still need assistance - and for that, there’s still the <a href="https://fastcomments.com/auth/my-account/help" target="_blank">customer support page</a>.
