...
Since launch, FastComments has authenticated via magic email links. This was because we could consolidate our login mechanisms into the same system used
...
Passwords are not stored. Rather, passwords are hashed with an 11-round salt using bcrypt. Access to the password-based system is limited
