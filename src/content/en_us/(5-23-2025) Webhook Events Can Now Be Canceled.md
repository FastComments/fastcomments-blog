...
Previously, canceling webhook events required a support ticket. They can now be canceled self-service by going to the
[logs page](https://fastcomments.com/auth/my-account/manage-data/webhooks/logs) and clicking the `x` next to the event. 

Additionally, the webhook logs UI has been significantly improved for speed.
