...
{{#unless isPost}}
FastComments now allows you to search by page and user on the comment moderation page.
{{/unless}}
...
Previously, FastComments allowed you to search by phrases or exact string match on the comment moderation page.
...
- **_New!_** By Page Title: **page:"Page Title"**
  ...
  - Shows the number of comments for each page in the autocomplete suggestion list.
