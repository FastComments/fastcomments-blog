...
We do not store your raw IP address. We only store an obfuscated form for security comparison purposes. The approximate location is determined at the time of login and is not stored.

**Your IP is not shared with a third party** to determine the location. We host our own service that extracts the approximate location from a (weekly updated) copy of the MaxMind database.
...
This is one more step toward keeping your account safe. If you receive an alert you don't recognize, we recommend changing your password immediately.
