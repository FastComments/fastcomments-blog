...
This link can also be customized by editing your <a href="https://fastcomments.com/auth/my-account/edit-details" target="_blank">Account Details</a>.
...
This feature has the side effect of reducing content flagged as spam that may not actually be spam. Comments with little text and a link have a higher chance of being classified
...
If you're an existing customer using FastComments, your users will experience no change in functionality unless you turn this feature on. The same applies to new customers - you'll
