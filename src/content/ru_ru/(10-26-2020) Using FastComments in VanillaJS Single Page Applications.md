...
Обратите внимание, что мы задокументировали полную конфигурацию, которую поддерживает виджет на TypeScript <a href="https://github.com/FastComments/fastcomments-typescript" target="_blank">на GitHub</a>.
