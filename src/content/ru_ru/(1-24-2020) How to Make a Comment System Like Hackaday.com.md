...
###### [postdate]
{{/unless}}
# [postlink]Как создать систему комментариев, подобную Hackaday.com[/postlink]

{{#unless isPost}}
Здесь мы рассмотрим создание потока комментариев, который выглядит как на Hackaday.

Если вы нажмете на ссылку на этот пост, общий стиль страницы, а также блог FastComments изменятся.
...
Сделать так, чтобы FastComments выглядел так — просто!
Мы создали для этого интерфейс! Например, вот конфигурация, которую мы использовали, чтобы сделать FastComments похожими на эту страницу:
...
document.getElementById('code').innerText = `
    window.FastCommentsUI(document.getElementById('fastcomments-widget'), {
        tenantId: 'demo',
        commentCountFormat: '[count] МЫСЛИ О "КАК СДЕЛАТЬ СИСТЕМУ КОММЕНТАРИЕВ, ПОДОБНУЮ HACKADAY.COM"',
...
- commentCountUpdated = Функция, которая вызывается, когда количество комментариев изменяется. Мы используем это, чтобы установить количество комментариев в
...
Все параметры конфигурации задокументированы <a href="https://github.com/FastComments/fastcomments-typescript" target="_blank">здесь</a>.
