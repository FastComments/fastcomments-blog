...
Обърнете внимание, че сме документирали цялата конфигурация, която уиджетът поддържа в TypeScript <a href="https://github.com/FastComments/fastcomments-typescript" target="_blank">в GitHub</a>.
