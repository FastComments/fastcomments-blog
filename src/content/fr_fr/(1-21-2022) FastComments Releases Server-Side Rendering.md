...
Où `$urlId` est l'url, ou l'identifiant, de la page. La documentation à ce sujet est [ici](https://docs.fastcomments.com/guide-customizations-and-configuration.html#url-id).
...
La documentation complète est disponible dans les [Docs SSR à docs.fastcomments.com](https://docs.fastcomments.com/guide-ssr.html).

## SSO

Parce que nous aimons les acronymes qui font sérieux, ne vous inquiétez pas, le SSR supporte le SSO. [Un exemple de Single-Sign-On avec SSR est ici.](https://github.com/FastComments/fastcomments-code-examples/blob/master/sso/php/ssr/server.php#L44)
