...
FastComments offre à ses clients un accès inégalé à leurs données grâce à une API d'agrégation flexible. Cette API vous permet de compter, d'enquêter, de découper et d'agréger
vos commentaires, votes et **34 autres ressources** !
...
Comme pour toutes les grandes versions, nous sommes heureux d'avoir pu prendre le temps d'optimiser, tester et publier correctement ces changements. Faites-nous savoir
