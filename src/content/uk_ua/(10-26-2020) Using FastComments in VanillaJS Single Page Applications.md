...
Зверніть увагу, що ми задокументували повну конфігурацію, яку підтримує віджет, в TypeScript <a href="https://github.com/FastComments/fastcomments-typescript" target="_blank">на GitHub</a>.
