...
Moodle 插件現已可用。如需完整的設置步驟，請查看 [Moodle 整合指南](https://docs.fastcomments.com/guide-installation-moodle.html)，源代碼位於 [GitHub](https://github.com/FastComments/fastcomments-moodle)。如果您有任何反饋，請在下面告訴我們！
