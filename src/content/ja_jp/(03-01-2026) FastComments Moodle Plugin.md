...
Moodle プラグインは現在利用可能です。完全な設定手順については、[Moodle 統合ガイド](https://docs.fastcomments.com/guide-installation-moodle.html)をご覧いただき、ソースコードは [GitHub](https://github.com/FastComments/fastcomments-moodle) で入手できます。フィードバックがあれば、以下でお知らせください！
