...
Moodle 플러그인은 지금 이용 가능합니다. 전체 설치 안내는 [Moodle 통합 가이드](https://docs.fastcomments.com/guide-moodle.html)를 확인하시고, 소스 코드는 [GitHub](https://github.com/FastComments/fastcomments-moodle)에서 확인하십시오. 피드백이 있으시면 아래에 남겨주세요!
