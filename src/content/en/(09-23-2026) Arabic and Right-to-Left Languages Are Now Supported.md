...
###### [postdate]
# [postlink]Arabic and Right-to-Left Languages Are Now Supported[/postlink]

{{#unless isPost}}
FastComments now speaks Arabic, and every part of FastComments lays out right-to-left for Arabic and Hebrew. Counts like "3 comments" also now use the correct plural form in every language.
{{/unless}}
...
<a href="https://docs.fastcomments.com/guide-supported-languages.html" target="_blank">The Supported Languages guide</a> lists
